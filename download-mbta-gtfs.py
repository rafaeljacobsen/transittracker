...
def main():
    ...
    if success:
        ...
        print("   - python parse-mbta-stops.py")
        print("   - python parse-bus-data.py")
        print("   - python parse-ferry-routes.py")
        print("   - python parse-shuttle-data.py")
        print("   - python parse-silver-line-data.py")
    else:
