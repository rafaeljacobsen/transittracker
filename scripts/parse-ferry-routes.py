#!/usr/bin/env python3
"""
Parse MBTA Ferry Routes from GTFS Data
"""
...
for route_id in tqdm(sorted(final_data.keys()), desc="Building stop data", unit="routes"):
    route_name = target_routes[route_id]['name']
...
with open(data_dir / "mbta-ferry-data.js", "w", encoding="utf-8") as f:
    f.write(js_content)

print("\n" + "="*50)
print("FERRY DATA PARSING COMPLETE")
print("="*50)
